# T52-Capstone Project - Hangman

## Rules of the game

The word to guess is represented by a row of dashes representing each letter of the word. 
If the user suggests by pressing a letter-button a letter which occurs in the word, it will appear in all its correct positions. 
...
* You can modify the code in JavaScript (.js) and add additional functionality
